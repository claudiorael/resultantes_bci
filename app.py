...
if file:
    try:
        ...
        if st.button("🚀 PROCESAR"):
            ...
            # Aplicar NOMPROPIO a recursos y descripciones
            columnas_titulo = [
            ...
            if not df_ventas.empty:
                ...
                # Mostramos el gráfico de barras con altura reducida
                st.bar_chart(conteo_ventas, color="#FF7F00", height=250)
            else:
